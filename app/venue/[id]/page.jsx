...
export default async function VenuePage({ params }) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-8 text-gray-800">{venue.venueName}</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="border border-gray-200 rounded-xl p-6 hover:shadow-sm transition-shadow">
          <h2 className="text-xl font-semibold mb-4 text-gray-700">Venue Details</h2>
          <div className="space-y-4">
            ...
            <p className="flex justify-between items-center">
              ...
              <span className="font-medium text-gray-800">{venue.parentTheme}</span>
            </p>
            <p className="flex justify-between items-center">
              <span className="text-gray-600">Capacity</span>
              <span className="font-medium text-gray-800">{venue.capacity}</span>
            </p>
            <p className="flex justify-between items-center">
        ...
        <div className="border border-gray-200 rounded-xl p-6 hover:shadow-sm transition-shadow">
          <h2 className="text-xl font-semibold mb-4 text-gray-700">Attendance Information</h2>
          <div className="space-y-4">
            <p className="flex justify-between items-center">
              <span className="text-gray-600">Total Attendees</span>
              <span className="font-medium text-gray-800">{venue.totalAttendees}</span>
            </p>
            <p className="flex justify-between items-center">
        ...
        {venue.attendees && venue.attendees.length > 0 && (
          <div className="col-span-full border border-gray-200 rounded-xl p-6 hover:shadow-sm transition-shadow">
            <h2 className="text-xl font-semibold mb-4 text-gray-700">Scheduled Attendance</h2>
